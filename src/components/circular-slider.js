// https://raw.githubusercontent.com/maslick/radiaSlider/master/src/slider-circular.js
(function () {
    class Slider {
        constructor(options) {
            this.sliders = {};
        ...
        addSlider(options) {
            ...
            this.setSliderValue(obj.id, options.value || options.min);
        }
        ...
        drawScale(slider) {
            ...
            // for (let i = 0; i <= 2 * Math.PI; i += Math.PI / 6) {
                ...
                this.context.strokeStyle = '#7771';
                // this.context.arc(this.x0, this.y0, slider.radius, i, i + Math.PI / 4, false);
                this.context.arc(this.x0, this.y0, slider.radius, 0, 15* Math.PI / 4, false);
        ...
        drawData(slider) {
            ...
            // this.context.lineTo(this.x0, this.y0 - slider.radius + this.scaleWidth / 2);
            // this.context.lineTo(this.x0 + this.scaleWidth / 4, this.y0 - slider.radius);
            // this.context.lineTo(this.x0, this.y0 - slider.radius -  this.scaleWidth / 2);
            this.context.stroke();
        }
